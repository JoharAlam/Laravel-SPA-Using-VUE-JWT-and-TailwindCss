...
<div class="rounded-b-2xl shadow-2xl flex bg-blue-500" style="height: 230px; z-index: -1;">
	<div class="mx-auto h-full flex justify-center items-center bg-white" style="margin-top: 179px;">
	    <div class="bg-gray-300 p-3 rounded-2xl shadow-md">
		    <div class="w-96 bg-white rounded-2xl shadow-xl pr-6 pl-6 pt-4 pb-4">
		        ...
		        <h1 class="text-gray-600 text-3xl pt-8">Reset Password</h1>
		        <h6 class="text-blue-500 font-bold">Create a new password below</h6>
		        ...
		        <form method="POST" action="{{ route('password.update') }}" class="pt-6">
		            ...
		            <div class="relative">
		                ...
		                <input id="email" type="email" class="pt-4 w-full rounded p-3 bg-blue-800 text-white placeholder-gray-300 outline-none focus:bg-blue-700" name="email" value="{{ $email ?? old('email') }}" placeholder="your@email.com" autocomplete="email" autofocus>
