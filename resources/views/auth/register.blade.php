...
<div class="rounded-b-2xl shadow-2xl flex bg-blue-500" style="height: 230px; z-index: -1;">
	<div class="mx-auto h-full flex justify-center items-center bg-white" style="margin-top: 245px;">
		<div class="bg-gray-300 p-3 rounded-2xl shadow-md">
		    <div class="w-96 bg-white rounded-2xl shadow-xl pr-6 pl-6 pt-4 pb-4">
		        ...
		        <h1 class="text-gray-600 text-3xl pt-8">Register</h1>
		        <h6 class="text-blue-500 font-bold">Enter your registration credentials below</h6>

		        <form method="POST" action="{{ route('register') }}" class="pt-6">
		            @csrf

		            <div class="relative">
		                <label for="name" class="uppercase text-blue-300 text-xs font-bold absolute pl-3 pt-2"><i class="fa fa-user"></i> Name</label>
		                <input id="name" type="text" class="pt-4 w-full rounded p-3 bg-blue-800 text-white placeholder-gray-300 outline-none focus:bg-blue-700" name="name" 
		            ...
		            <div class="relative pt-3">
		                ...
		                <input id="password" type="password" class="pt-4 w-full rounded p-3 bg-blue-800 text-white placeholder-gray-300 outline-none focus:bg-blue-700" 
		            ...
		            <div class="relative pt-3">
		                <label for="password-confirm" class="uppercase text-blue-300 text-xs font-bold absolute pl-3 pt-2"><i class="fas fa-lock"></i> Confirm Password</label>
		                <input id="password-confirm" type="password" class="pt-4 w-full rounded p-3 bg-blue-800 text-white placeholder-gray-300 outline-none focus:bg-blue-700" 
