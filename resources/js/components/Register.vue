	...
	<div class="mx-auto h-screen flex justify-center items-center bg-gray-300">
	    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
	        ...
	        <div class="relative pt-8">
	            ...
	            <input type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700"
	            v-model="form.name" placeholder="Full Name" autocomplete="name" autofocus>
	        </div>

	        <div class="relative pt-3">
	            <label for="email" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">E-mail</label>
	            <input type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" 
	            v-model="form.email" placeholder="your@email.com" autocomplete="email">
	        </div>

	        <div class="relative pt-3">
	            <label for="password" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">PAssword</label>
	            <input type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" 
	            v-model="form.password" placeholder="********" autocomplete="new-password">
	        </div>

	        <div class="relative pt-3">
	            <label for="password-confirm" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Confirm Password</label>
	            <input type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" 
	            v-model="form.password_confirmation" placeholder="********" autocomplete="new-password">
	        </div>

	        <div class="pt-8">
	            <button @click.prevent="saveForm" type="submit" class="w-full uppercase rounded text-left text-blue-900 bg-gray-400 py-2 px-3 font-bold">
	            	Register
	            </button>
	        </div>
...
<script>
	export default{
		...
		methods:{
			saveForm(){
				axios.post('/api/registerUser', this.form).then(() =>{
				console.log('Saved');
