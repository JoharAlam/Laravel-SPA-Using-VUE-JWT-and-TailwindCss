    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="pt-8">
            ...
            <div class="relative">
                ...
                value="<?php echo e(old('name')); ?>" placeholder="Full Name" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative pt-3">
                ...
                value="<?php echo e(old('email')); ?>" placeholder="your@email.com" autocomplete="email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\VueSpaJwt-App\resources\views/auth/register.blade.php ENDPATH**/ ?>